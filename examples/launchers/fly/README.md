...
```bash
docker build -t trace-fly-launcher-example examples/launchers/fly
```

Run it:

```bash
docker run --rm -p 8787:8787 --env-file examples/launchers/fly/.env trace-fly-launcher-example
```
