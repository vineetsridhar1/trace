...
const documents: Documents = {
  ...
  "\n  query DesignSystemHistory($id: ID!) {\n    designSystemCommitArtifacts(designSystemId: $id, first: 50) {\n      edges {\n        node {\n          id\n          designSystemId\n          sequence\n          commitSha\n          status\n          packageValid\n          packageDigest\n          byteSize\n          error\n          createdAt\n          savedAt\n        }\n      }\n    }\n    designSystemVersions(designSystemId: $id) {\n      id\n      designSystemId\n      version\n      contentDigest\n      byteSize\n      sourceCommitSha\n      workbenchCommitSha\n      createdAt\n    }\n  }\n":
    types.DesignSystemHistoryDocument,
  "\n  mutation SaveDesignSystem($id: ID!) {\n    saveDesignSystem(id: $id) {\n      id\n      version\n    }\n  }\n":
    types.SaveDesignSystemDocument,
  "\n  mutation RetryDesignSystemCommit($designSystemId: ID!) {\n    retryDesignSystemCommitArtifact(designSystemId: $designSystemId) {\n      id\n      commitArtifactStatus\n    }\n  }\n":
    types.RetryDesignSystemCommitDocument,
  "\n  mutation RefreshDesignSystemSource($id: ID!) {\n    refreshDesignSystemSource(id: $id) {\n      id\n      sourceCommitSha\n      updatedAt\n    }\n  }\n":
    types.RefreshDesignSystemSourceDocument,
  "\n  mutation ArchiveDesignSystem($id: ID!) {\n    archiveDesignSystem(id: $id) {\n      id\n      status\n      archivedAt\n    }\n  }\n":
    types.ArchiveDesignSystemDocument,
  "\n  query SessionGroupBranchDiff($sessionGroupId: ID!) {\n    sessionGroupBranchDiff(sessionGroupId: $sessionGroupId) {\n      path\n      status\n      additions\n      deletions\n    }\n  }\n":
  ...
  "\n  query SidebarDesignSystems($organizationId: ID!) {\n    designSystems(organizationId: $organizationId) {\n      id\n      organizationId\n      name\n      description\n      status\n      archivedAt\n      authoringSessionGroupId\n      sourceRepoId\n      sourceBranch\n      sourcePath\n      sourceCommitSha\n      sourceRepo {\n        id\n        name\n      }\n      commitArtifactStatus\n      commitArtifactError\n      publishStatus\n      publishError\n      latestPushedCommitSha\n      activeVersionId\n      activeVersion {\n        id\n        designSystemId\n        version\n        sourceCommitSha\n        workbenchCommitSha\n        createdAt\n      }\n      latestCommitArtifact {\n        id\n        designSystemId\n        sequence\n        commitSha\n        status\n        packageValid\n        packageDigest\n        error\n        createdAt\n        savedAt\n      }\n      authoringSessionGroup {\n        id\n        name\n        kind\n        status\n        archivedAt\n        updatedAt\n        sessions {\n          id\n          sessionGroupId\n          agentStatus\n          sessionStatus\n          updatedAt\n          createdAt\n        }\n      }\n    }\n  }\n":
    types.SidebarDesignSystemsDocument,
  "\n  query DesignSessionGroups($organizationId: ID!) {\n    designSessionGroups(organizationId: $organizationId) {\n      id\n      name\n      slug\n      kind\n      status\n      visibility\n      archivedAt\n      connection {\n        state\n      }\n      sessions {\n        id\n        sessionGroupId\n        agentStatus\n        sessionStatus\n        prUrl\n        worktreeDeleted\n        lastMessageAt\n        lastUserMessageAt\n        updatedAt\n        createdAt\n      }\n    }\n  }\n":
    types.DesignSessionGroupsDocument,
  "\n  query GeneratedProjects($organizationId: ID!) {\n    appSessionGroups(organizationId: $organizationId) {\n      id\n      name\n      slug\n      kind\n      status\n      visibility\n      owner {\n        id\n      }\n      designPreviewUrl\n      gitCheckpoints {\n        id\n        committedAt\n        previewStatus\n        previewUrl\n      }\n      archivedAt\n      updatedAt\n      connection {\n        state\n      }\n      sessions {\n        id\n        sessionGroupId\n        agentStatus\n        sessionStatus\n        prUrl\n        worktreeDeleted\n        lastMessageAt\n        lastUserMessageAt\n        updatedAt\n        createdAt\n      }\n    }\n    designSessionGroups(organizationId: $organizationId) {\n      id\n      name\n      slug\n      kind\n      status\n      visibility\n      owner {\n        id\n      }\n      designPreviewUrl\n      gitCheckpoints {\n        id\n        committedAt\n        previewStatus\n        previewUrl\n      }\n      archivedAt\n      updatedAt\n      connection {\n        state\n      }\n      sessions {\n        id\n        sessionGroupId\n        agentStatus\n        sessionStatus\n        prUrl\n        worktreeDeleted\n        lastMessageAt\n        lastUserMessageAt\n        updatedAt\n        createdAt\n      }\n    }\n    pdfSessionGroups(organizationId: $organizationId) {\n      id\n      name\n      slug\n      kind\n      status\n      visibility\n      owner {\n        id\n      }\n      designPreviewUrl\n      gitCheckpoints {\n        id\n        committedAt\n        previewStatus\n        previewUrl\n      }\n      archivedAt\n      updatedAt\n      pdfExportStatus\n      pdfExportCommitSha\n      pdfExportCapturedAt\n      pdfExportError\n      pdfPageWidth\n      pdfPageHeight\n      pdfPageUnit\n      pdfFormatVersion\n      connection {\n        state\n      }\n      sessions {\n        id\n        sessionGroupId\n        agentStatus\n        sessionStatus\n        prUrl\n        worktreeDeleted\n        lastMessageAt\n        lastUserMessageAt\n        updatedAt\n        createdAt\n      }\n    }\n  }\n":
    types.GeneratedProjectsDocument,
  "\n  mutation DeleteChannelGroup($id: ID!) {\n    deleteChannelGroup(id: $id)\n  }\n":
