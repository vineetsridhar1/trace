...
const documents: Documents = {
    ...
    "\n  mutation CreateAiConversation($organizationId: ID!, $input: CreateAiConversationInput!) {\n    createAiConversation(organizationId: $organizationId, input: $input) {\n      id\n    }\n  }\n": types.CreateAiConversationDocument,
    "\n  mutation SendTurn($branchId: ID!, $content: String!, $clientMutationId: String) {\n    sendTurn(branchId: $branchId, content: $content, clientMutationId: $clientMutationId) {\n      id\n    }\n  }\n": types.SendTurnDocument,
    "\n  mutation UpdateAiConversationTitle($conversationId: ID!, $title: String!) {\n    updateAiConversationTitle(conversationId: $conversationId, title: $title) {\n      id\n    }\n  }\n": types.UpdateAiConversationTitleDocument,
    "\n  mutation UpdateAgentObservability($conversationId: ID!, $level: AgentObservability!) {\n    updateAgentObservability(conversationId: $conversationId, level: $level) {\n      id\n    }\n  }\n": types.UpdateAgentObservabilityDocument,
    "\n  query AiConversations($organizationId: ID!) {\n    aiConversations(organizationId: $organizationId) {\n      id\n      title\n      visibility\n      branchCount\n      createdBy {\n        id\n      }\n      rootBranch {\n        id\n      }\n      createdAt\n      updatedAt\n    }\n  }\n": types.AiConversationsDocument,
    "\n  mutation UpdateAiConversationVisibility($conversationId: ID!, $visibility: AiConversationVisibility!) {\n    updateAiConversationVisibility(conversationId: $conversationId, visibility: $visibility) {\n      id\n    }\n  }\n": types.UpdateAiConversationVisibilityDocument,
    "\n  query AiConversations($organizationId: ID!) {\n    aiConversations(organizationId: $organizationId) {\n      id\n      title\n      visibility\n      branchCount\n      createdBy {\n        id\n        name\n      }\n      rootBranch {\n        id\n      }\n      createdAt\n      updatedAt\n    }\n  }\n": types.AiConversationsDocument,
    "\n  query AiConversation($id: ID!) {\n    aiConversation(id: $id) {\n      id\n      title\n      visibility\n      branchCount\n      createdBy {\n        id\n      }\n      rootBranch {\n        id\n      }\n      branches {\n        id\n        label\n        depth\n        turnCount\n        parentBranch {\n          id\n        }\n        forkTurn {\n          id\n        }\n        childBranches {\n          id\n        }\n        createdBy {\n          id\n        }\n        createdAt\n      }\n      createdAt\n      updatedAt\n    }\n  }\n": types.AiConversationDocument,
    "\n  mutation UpdateAiConversationObservability($conversationId: ID!, $agentObservability: AgentObservability!) {\n    updateAiConversationObservability(conversationId: $conversationId, agentObservability: $agentObservability) {\n      id\n    }\n  }\n": types.UpdateAiConversationObservabilityDocument,
    "\n  mutation LabelBranch($branchId: ID!, $label: String!) {\n    labelBranch(branchId: $branchId, label: $label) {\n      id\n    }\n  }\n": types.LabelBranchDocument,
    "\n  mutation ForkBranch($branchId: ID!, $turnId: ID!, $label: String) {\n    forkBranch(branchId: $branchId, turnId: $turnId, label: $label) {\n      id\n    }\n  }\n": types.ForkBranchDocument,
    "\n  mutation LinkConversationEntity($conversationId: ID!, $entityType: String!, $entityId: ID!) {\n    linkConversationEntity(conversationId: $conversationId, entityType: $entityType, entityId: $entityId) {\n      id\n    }\n  }\n": types.LinkConversationEntityDocument,
    "\n  mutation UnlinkConversationEntity($conversationId: ID!, $entityType: String!, $entityId: ID!) {\n    unlinkConversationEntity(conversationId: $conversationId, entityType: $entityType, entityId: $entityId)\n  }\n": types.UnlinkConversationEntityDocument,
    "\n  query AiConversations($organizationId: ID!) {\n    aiConversations(organizationId: $organizationId) {\n      id\n      title\n      visibility\n      agentObservability\n      branchCount\n      createdBy {\n        id\n      }\n      rootBranch {\n        id\n      }\n      createdAt\n      updatedAt\n    }\n  }\n": types.AiConversationsDocument,
    "\n  query AiConversation($id: ID!) {\n    aiConversation(id: $id) {\n      id\n      title\n      visibility\n      agentObservability\n      branchCount\n      createdBy {\n        id\n      }\n      rootBranch {\n        id\n      }\n      linkedEntities {\n        id\n        conversationId\n        entityType\n        entityId\n        createdById\n        createdAt\n      }\n      branches {\n        id\n        label\n        depth\n        turnCount\n        parentBranch {\n          id\n        }\n        forkTurn {\n          id\n        }\n        childBranches {\n          id\n        }\n        createdBy {\n          id\n        }\n        createdAt\n      }\n      createdAt\n      updatedAt\n    }\n  }\n": types.AiConversationDocument,
    "\n  query BranchTimeline($id: ID!) {\n    branch(id: $id) {\n      id\n      label\n      depth\n      turnCount\n      parentBranch {\n        id\n      }\n      forkTurn {\n        id\n      }\n      childBranches {\n        id\n      }\n      createdBy {\n        id\n      }\n      createdAt\n      conversation {\n        id\n      }\n      turns {\n        id\n        role\n        content\n        parentTurn {\n          id\n        }\n        branchCount\n        createdAt\n      }\n    }\n  }\n": types.BranchTimelineDocument,
    "\n  subscription ConversationEvents($conversationId: ID!) {\n    conversationEvents(conversationId: $conversationId) {\n      conversationId\n      type\n      payload\n      timestamp\n    }\n  }\n": types.ConversationEventsDocument,
    "\n  subscription BranchTurns($branchId: ID!) {\n    branchTurns(branchId: $branchId) {\n      id\n      role\n      content\n      parentTurn {\n        id\n      }\n      branchCount\n      createdAt\n      branch {\n        id\n      }\n    }\n  }\n": types.BranchTurnsDocument,
