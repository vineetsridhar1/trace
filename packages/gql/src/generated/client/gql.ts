...
const documents: Documents = {
  "\n  fragment AssistantSessionFields on Session {\n    id\n    name\n    kind\n    agentStatus\n    sessionStatus\n    tool\n    model\n    reasoningEffort\n    hosting\n    repo {\n      id\n      name\n      remoteUrl\n    }\n    branch\n    workdir\n    prUrl\n    worktreeDeleted\n    lastUserMessageAt\n    lastMessageAt\n    connection {\n      state\n      runtimeInstanceId\n      runtimeLabel\n      lastError\n      retryCount\n      canRetry\n      canMove\n      autoRetryable\n    }\n    createdBy {\n      id\n      name\n      avatarUrl\n    }\n    sessionGroupId\n    channel {\n      id\n    }\n    queuedMessages {\n      id\n      sessionId\n      text\n      imageKeys: attachmentKeys\n      interactionMode\n      position\n      createdAt\n    }\n    createdAt\n    updatedAt\n  }\n":
    types.AssistantSessionFieldsFragmentDoc,
  "\n  \n  query OrgAssistantSessions($organizationId: ID!) {\n    orgAssistantSessions(organizationId: $organizationId) {\n      ...AssistantSessionFields\n    }\n    orgAssistantSession(organizationId: $organizationId) {\n      ...AssistantSessionFields\n    }\n  }\n":
    types.OrgAssistantSessionsDocument,
  "\n  \n  mutation CreateOrgAssistantSession($organizationId: ID!) {\n    createOrgAssistantSession(organizationId: $organizationId) {\n      ...AssistantSessionFields\n    }\n  }\n":
    types.CreateOrgAssistantSessionDocument,
  "\n  mutation SendChannelMessage($channelId: ID!, $html: String, $parentId: ID) {\n    sendChannelMessage(channelId: $channelId, html: $html, parentId: $parentId) {\n      id\n    }\n  }\n":
