...
const documents: Documents = {
  ...
  "\n  mutation StartUltraplanFromComposer($input: StartUltraplanInput!) {\n    startUltraplan(input: $input) {\n      id\n      status\n      sessionGroupId\n      updatedAt\n    }\n  }\n":
    types.StartUltraplanFromComposerDocument,
  "\n  mutation PauseUltraplanFromGroup($id: ID!) {\n    pauseUltraplan(id: $id) {\n      id\n    }\n  }\n":
    types.PauseUltraplanFromGroupDocument,
  "\n  mutation ResumeUltraplanFromGroup($id: ID!) {\n    resumeUltraplan(id: $id) {\n      id\n    }\n  }\n":
    types.ResumeUltraplanFromGroupDocument,
  "\n  mutation RunUltraplanControllerFromGroup($id: ID!) {\n    runUltraplanControllerNow(id: $id) {\n      id\n    }\n  }\n":
    types.RunUltraplanControllerFromGroupDocument,
  "\n  mutation CancelUltraplanFromGroup($id: ID!) {\n    cancelUltraplan(id: $id) {\n      id\n    }\n  }\n":
    types.CancelUltraplanFromGroupDocument,
  "\n  query AgentIdentity($organizationId: ID!) {\n    agentIdentity(organizationId: $organizationId) {\n      id\n      name\n      status\n      autonomyMode\n      soulFile\n    }\n  }\n":
