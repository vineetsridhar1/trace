...
const documents: Documents = {
  ...
  "\n  mutation ArchiveDesignSystemFromGallery($id: ID!) {\n    archiveDesignSystem(id: $id) {\n      id\n      archivedAt\n    }\n  }\n":
    types.ArchiveDesignSystemFromGalleryDocument,
  "\n  query GalleryDesignSystems($organizationId: ID!) {\n    designSystems(organizationId: $organizationId) {\n      id\n      authoringSessionGroupId\n      archivedAt\n      name\n      status\n    }\n  }\n":
    types.GalleryDesignSystemsDocument,
  "\n  query GeneratedProjects($organizationId: ID!) {\n    appSessionGroups(organizationId: $organizationId) {\n      id\n      name\n      slug\n      kind\n      status\n      visibility\n      owner {\n        id\n      }\n      designPreviewUrl\n      gitCheckpoints {\n        id\n        committedAt\n        previewStatus\n        previewUrl\n      }\n      archivedAt\n      updatedAt\n      connection {\n        state\n      }\n      sessions {\n        id\n        sessionGroupId\n        agentStatus\n        sessionStatus\n        prUrl\n        worktreeDeleted\n        lastMessageAt\n        lastUserMessageAt\n        updatedAt\n        createdAt\n      }\n    }\n    designSessionGroups(organizationId: $organizationId) {\n      id\n      name\n      slug\n      kind\n      status\n      visibility\n      owner {\n        id\n      }\n      designPreviewUrl\n      gitCheckpoints {\n        id\n        committedAt\n        previewStatus\n        previewUrl\n      }\n      archivedAt\n      updatedAt\n      connection {\n        state\n      }\n      sessions {\n        id\n        sessionGroupId\n        agentStatus\n        sessionStatus\n        prUrl\n        worktreeDeleted\n        lastMessageAt\n        lastUserMessageAt\n        updatedAt\n        createdAt\n      }\n    }\n    pdfSessionGroups(organizationId: $organizationId) {\n      id\n      name\n      slug\n      kind\n      status\n      visibility\n      owner {\n        id\n      }\n      designPreviewUrl\n      gitCheckpoints {\n        id\n        committedAt\n        previewStatus\n        previewUrl\n      }\n      archivedAt\n      updatedAt\n      pdfExportStatus\n      pdfExportCommitSha\n      pdfExportCapturedAt\n      pdfExportError\n      pdfPageWidth\n      pdfPageHeight\n      pdfPageUnit\n      pdfFormatVersion\n      connection {\n        state\n      }\n      sessions {\n        id\n        sessionGroupId\n        agentStatus\n        sessionStatus\n        prUrl\n        worktreeDeleted\n        lastMessageAt\n        lastUserMessageAt\n        updatedAt\n        createdAt\n      }\n    }\n  }\n":
