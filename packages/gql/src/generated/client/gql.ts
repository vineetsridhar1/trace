...
const documents: Documents = {
  "\n  query SessionGroupArtifacts($sessionGroupId: ID!) {\n    artifacts(sessionGroupId: $sessionGroupId) {\n      id\n      organizationId\n      sessionId\n      type\n      key\n      bundleDigest\n      byteSize\n      createdAt\n      manifest {\n        schemaVersion\n        files {\n          path\n          mediaType\n          size\n          digest\n        }\n      }\n      session {\n        id\n        name\n        sessionGroupId\n      }\n    }\n  }\n":
    types.SessionGroupArtifactsDocument,
  "\n  mutation AddChannelMember($input: AddChannelMemberInput!) {\n    addChannelMember(input: $input) {\n      id\n    }\n  }\n":
  ...
  "\n  query DesignCreationOptions($organizationId: ID!) {\n    repos(organizationId: $organizationId) {\n      id\n      name\n      remoteUrl\n      provider\n    }\n    agentEnvironments(orgId: $organizationId) {\n      id\n      name\n      adapterType\n      enabled\n      isDefault\n    }\n  }\n":
    types.DesignCreationOptionsDocument,
  "\n  mutation CreateDesignSystem($input: CreateDesignSystemInput!) {\n    createDesignSystem(input: $input) {\n      id\n      authoringSessionGroupId\n    }\n  }\n":
    types.CreateDesignSystemDocument,
  "\n  query HomeComposerDesigns($organizationId: ID!) {\n    designSessionGroups(organizationId: $organizationId) {\n      id\n      name\n      kind\n      archivedAt\n      designPreviewCommitSha\n    }\n  }\n":
    types.HomeComposerDesignsDocument,
  "\n  query HomeComposerDesignSystems($organizationId: ID!) {\n    designSystems(organizationId: $organizationId) {\n      id\n      name\n      status\n      archivedAt\n      activeVersionId\n      activeVersion {\n        id\n        version\n      }\n      sourceRepo {\n        id\n        name\n      }\n    }\n  }\n":
    types.HomeComposerDesignSystemsDocument,
  "\n  query HomeCreations($organizationId: ID!) {\n    appSessionGroups(organizationId: $organizationId, includeArchived: true) {\n      ...BaseCreationGroup\n    }\n  }\n\n  fragment BaseCreationGroup on SessionGroup {\n    id\n    name\n    slug\n    kind\n    status\n    visibility\n    archivedAt\n    createdAt\n    updatedAt\n    owner {\n      id\n      name\n      avatarUrl\n    }\n    connection {\n      state\n    }\n    sessions {\n      id\n      sessionGroupId\n      createdById\n      agentStatus\n      sessionStatus\n      prUrl\n      worktreeDeleted\n      lastMessageAt\n      lastUserMessageAt\n      updatedAt\n      createdAt\n    }\n  }\n":
    types.HomeCreationsDocument,
  "\n  query HomeDesigns($organizationId: ID!) {\n    designSessionGroups(organizationId: $organizationId, includeArchived: true) {\n      ...DesignCreationGroup\n    }\n  }\n\n  fragment DesignCreationGroup on SessionGroup {\n    id\n    name\n    slug\n    kind\n    status\n    visibility\n    archivedAt\n    designPreviewUrl\n    createdAt\n    updatedAt\n    owner {\n      id\n      name\n      avatarUrl\n    }\n    connection {\n      state\n    }\n    sessions {\n      id\n      sessionGroupId\n      createdById\n      agentStatus\n      sessionStatus\n      prUrl\n      worktreeDeleted\n      lastMessageAt\n      lastUserMessageAt\n      updatedAt\n      createdAt\n    }\n  }\n":
    types.HomeDesignsDocument,
  "\n  query SessionGroupBranchDiff($sessionGroupId: ID!) {\n    sessionGroupBranchDiff(sessionGroupId: $sessionGroupId) {\n      path\n      status\n      additions\n      deletions\n    }\n  }\n":
  ...
  "\n  mutation ApproveArtifact($artifactId: ID!, $action: ArtifactApprovalAction!, $prompt: String!) {\n    approveArtifact(artifactId: $artifactId, action: $action, prompt: $prompt) {\n      implementationSession {\n        id\n        sessionGroupId\n        channel {\n          id\n        }\n      }\n    }\n  }\n":
    types.ApproveArtifactDocument,
  "\n  query SessionDetail($id: ID!) {\n    session(id: $id) {\n      id\n      name\n      agentStatus\n      sessionStatus\n      tool\n      model\n      reasoningEffort\n      hosting\n      repo {\n        id\n        name\n        remoteUrl\n      }\n      branch\n      workdir\n      prUrl\n      worktreeDeleted\n      lastUserMessageAt\n      lastMessageAt\n      inputTokens\n      outputTokens\n      cacheReadTokens\n      cacheCreationTokens\n      connection {\n        state\n        runtimeInstanceId\n        runtimeLabel\n        lastError\n        retryCount\n        canRetry\n        canMove\n        autoRetryable\n      }\n      createdBy {\n        id\n        name\n        avatarUrl\n      }\n      sessionGroupId\n      sessionGroup {\n        id\n        name\n        branch\n        prUrl\n        workdir\n        worktreeDeleted\n        designPreviewUrl\n        channel {\n          id\n        }\n        repo {\n          id\n          name\n          remoteUrl\n          applicationConfig {\n            setupScripts {\n              id\n              name\n              command\n              workingDirectory\n              env {\n                key\n                secretName\n              }\n            }\n            applications {\n              id\n              name\n              processes {\n                id\n                name\n                command\n                workingDirectory\n                env {\n                  key\n                  secretName\n                }\n                required\n                ports {\n                  id\n                  label\n                  port\n                  protocol\n                  defaultForwardingEnabled\n                  healthPath\n                }\n              }\n            }\n          }\n        }\n        connection {\n          state\n          runtimeInstanceId\n          runtimeLabel\n          lastError\n          retryCount\n          canRetry\n          canMove\n          autoRetryable\n        }\n        createdAt\n        updatedAt\n        setupStatus\n        setupError\n      }\n      channel {\n        id\n      }\n      queuedMessages {\n        id\n        sessionId\n        text\n        imageKeys: attachmentKeys\n        interactionMode\n        position\n        createdAt\n      }\n      artifacts {\n        id\n        organizationId\n        sessionId\n        type\n        key\n        bundleDigest\n        byteSize\n        manifest {\n          schemaVersion\n          files {\n            path\n            mediaType\n            size\n            digest\n          }\n        }\n        createdBy {\n          id\n          name\n          avatarUrl\n        }\n        createdAt\n      }\n      createdAt\n      updatedAt\n    }\n  }\n":
    types.SessionDetailDocument,
  "\n  query HiddenSessionTabs($sessionGroupId: ID!) {\n    hiddenSessionTabs(sessionGroupId: $sessionGroupId) {\n      sessionId\n      hiddenAt\n    }\n  }\n":
    types.HiddenSessionTabsDocument,
  "\n  query SessionGroupDetail($id: ID!) {\n    sessionGroup(id: $id) {\n      id\n      name\n      kind\n      slug\n      forkedFromSessionGroupId\n      status\n      visibility\n      designSystemVersionId\n      owner {\n        id\n        name\n        avatarUrl\n      }\n      archivedAt\n      branch\n      prUrl\n      workdir\n      worktreeDeleted\n      worktreeAdopted\n      designPreviewUrl\n      pdfExportStatus\n      pdfExportCommitSha\n      pdfExportCapturedAt\n      pdfExportError\n      pdfPageWidth\n      pdfPageHeight\n      pdfPageUnit\n      pdfFormatVersion\n      animationPreviewUrl\n      animationPreviewStatus\n      animationPreviewCommitSha\n      animationPreviewCapturedAt\n      animationPreviewError\n      repo {\n        id\n        name\n        remoteUrl\n        defaultBranch\n      }\n      connection {\n        state\n        runtimeInstanceId\n        runtimeLabel\n        lastError\n        retryCount\n        canRetry\n        canMove\n        autoRetryable\n      }\n      channel {\n        id\n      }\n      setupStatus\n      setupError\n      createdAt\n      updatedAt\n      sessions {\n        id\n        name\n        agentStatus\n        sessionStatus\n        tool\n        model\n        reasoningEffort\n        hosting\n        branch\n        workdir\n        worktreeDeleted\n        sessionGroupId\n        lastUserMessageAt\n        lastMessageAt\n        inputTokens\n        outputTokens\n        cacheReadTokens\n        cacheCreationTokens\n        connection {\n          state\n          runtimeInstanceId\n          runtimeLabel\n          lastError\n          retryCount\n          canRetry\n          canMove\n          autoRetryable\n        }\n        createdBy {\n          id\n          name\n          avatarUrl\n        }\n        repo {\n          id\n          name\n          remoteUrl\n        }\n        channel {\n          id\n        }\n        createdAt\n        updatedAt\n      }\n    }\n  }\n":
    types.SessionGroupDetailDocument,
  "\n  query DesignComposerOptions($organizationId: ID!) {\n    designSystems(organizationId: $organizationId) {\n      id\n      name\n      status\n      archivedAt\n      latestCommitArtifact {\n        id\n        status\n        packageValid\n        validationSummary\n      }\n      commitArtifactStatus\n      publishStatus\n      activeVersionId\n      activeVersion {\n        id\n        version\n      }\n      sourceRepo {\n        id\n        name\n      }\n    }\n  }\n":
    types.DesignComposerOptionsDocument,
  "\n  query SessionEndpointTrafficEndpoints($sessionGroupId: ID!) {\n    sessionEndpoints(sessionGroupId: $sessionGroupId) {\n      id\n      key\n      url\n      sessionGroupId\n      appConfigId\n      processConfigId\n      portConfigId\n      label\n      targetPort\n      status\n      accessMode\n      trafficCaptureMode\n      enabledAt\n      disabledAt\n      revokedAt\n    }\n  }\n":
  ...
  "\n  mutation SetApiTokenFromRecoveryCard($input: SetApiTokenInput!) {\n    setApiToken(input: $input) {\n      provider\n      isSet\n    }\n  }\n":
    types.SetApiTokenFromRecoveryCardDocument,
  "\n  mutation SetCodexCredentialFromRecoveryCard($input: SetCodexCredentialInput!) {\n    setCodexCredential(input: $input) {\n      method\n      updatedAt\n    }\n  }\n":
    types.SetCodexCredentialFromRecoveryCardDocument,
  "\n  query SessionGroupFileTree($sessionGroupId: ID!) {\n    sessionGroupFileTree(sessionGroupId: $sessionGroupId) {\n      paths\n      truncated\n    }\n  }\n":
  ...
  "\n  mutation HideSessionTab($sessionId: ID!) {\n    hideSessionTab(sessionId: $sessionId) {\n      sessionId\n      hiddenAt\n    }\n  }\n":
    types.HideSessionTabDocument,
  "\n  mutation RestoreSessionTab($sessionId: ID!) {\n    restoreSessionTab(sessionId: $sessionId)\n  }\n":
    types.RestoreSessionTabDocument,
  "\n  query MyApiTokens {\n    myApiTokens {\n      provider\n      isSet\n      updatedAt\n    }\n    myCodexCredential {\n      method\n      updatedAt\n    }\n  }\n":
  ...
  "\n  query AppSessionGroups($organizationId: ID!) {\n    appSessionGroups(organizationId: $organizationId) {\n      id\n      name\n      slug\n      kind\n      status\n      visibility\n      connection {\n        state\n      }\n      sessions {\n        id\n        sessionGroupId\n        agentStatus\n        sessionStatus\n        prUrl\n        worktreeDeleted\n        lastMessageAt\n        lastUserMessageAt\n        updatedAt\n        createdAt\n      }\n    }\n  }\n":
    types.AppSessionGroupsDocument,
  "\n  query AllChannels($organizationId: ID!) {\n    channels(organizationId: $organizationId) {\n      id\n      name\n      type\n      visibility\n      memberCount\n      viewerIsMember\n    }\n  }\n":
  ...
  "\n  query SharedChannel($id: ID!) {\n    channel(id: $id) {\n      id\n      name\n      type\n      visibility\n      position\n      groupId\n      baseBranch\n      setupScript\n      runScripts\n      viewerIsMember\n      repo {\n        id\n        name\n      }\n    }\n  }\n":
    types.SharedChannelDocument,
  "\n  query DesignElementEditorStyleSource($sessionGroupId: ID!, $elementId: String!) {\n    designElementStyleSource(sessionGroupId: $sessionGroupId, elementId: $elementId) {\n      sourceHash\n      styles {\n        color\n        backgroundColor\n        fontFamily\n        fontSize\n        fontWeight\n        fontStyle\n        textDecoration\n        textAlign\n        lineHeight\n        letterSpacing\n        textTransform\n        width\n        height\n        minWidth\n        maxWidth\n        minHeight\n        maxHeight\n        flexGrow\n        alignSelf\n        position\n        top\n        right\n        bottom\n        left\n        zIndex\n        display\n        flexDirection\n        justifyContent\n        alignItems\n        gap\n        borderRadius\n        paddingX\n        paddingY\n        paddingTop\n        paddingRight\n        paddingBottom\n        paddingLeft\n        marginTop\n        marginRight\n        marginBottom\n        marginLeft\n        opacity\n        overflow\n        objectFit\n        borderColor\n        borderWidth\n        borderStyle\n        cursor\n        pointerEvents\n        whiteSpace\n        textOverflow\n        boxSizing\n        aspectRatio\n        boxShadow\n        textShadow\n        transform\n        filter\n      }\n    }\n  }\n":
    types.DesignElementEditorStyleSourceDocument,
  "\n  query DesignElementEditorTextSource(\n    $sessionGroupId: ID!\n    $filePath: String!\n    $elementId: String!\n  ) {\n    designElementTextSource(\n      sessionGroupId: $sessionGroupId\n      filePath: $filePath\n      elementId: $elementId\n    ) {\n      text\n      sourceHash\n    }\n  }\n":
    types.DesignElementEditorTextSourceDocument,
  "\n  mutation SaveManualElementEdits($sessionGroupId: ID!, $inputs: [ManualElementEditInput!]!) {\n    saveManualElementEdits(sessionGroupId: $sessionGroupId, inputs: $inputs) {\n      commitSha\n    }\n  }\n":
    types.SaveManualElementEditsDocument,
  "\n  query OnboardingRepos($organizationId: ID!) {\n    repos(organizationId: $organizationId) {\n      id\n      name\n      provider\n      remoteUrl\n      defaultBranch\n      webhookActive\n    }\n  }\n":
