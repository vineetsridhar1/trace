 ...
 */
type Documents = {
  "\n  query SessionGroupArtifactPage(\n    $sessionGroupId: ID!\n    $limit: Int!\n    $before: DateTime\n    $beforeId: ID\n  ) {\n    artifactPage(\n      sessionGroupId: $sessionGroupId\n      limit: $limit\n      before: $before\n      beforeId: $beforeId\n    ) {\n      hasMore\n      items {\n        id\n        organizationId\n        sessionId\n        type\n        key\n        bundleDigest\n        byteSize\n        createdAt\n        approvalStatus\n        approvalAction\n        approvedAt\n        manifest {\n          schemaVersion\n          files {\n            path\n            mediaType\n            size\n            digest\n          }\n        }\n        session {\n          id\n          name\n          sessionGroupId\n        }\n      }\n    }\n  }\n": typeof types.SessionGroupArtifactPageDocument;
...
const documents: Documents = {
  "\n  query SessionGroupArtifactPage(\n    $sessionGroupId: ID!\n    $limit: Int!\n    $before: DateTime\n    $beforeId: ID\n  ) {\n    artifactPage(\n      sessionGroupId: $sessionGroupId\n      limit: $limit\n      before: $before\n      beforeId: $beforeId\n    ) {\n      hasMore\n      items {\n        id\n        organizationId\n        sessionId\n        type\n        key\n        bundleDigest\n        byteSize\n        createdAt\n        approvalStatus\n        approvalAction\n        approvedAt\n        manifest {\n          schemaVersion\n          files {\n            path\n            mediaType\n            size\n            digest\n          }\n        }\n        session {\n          id\n          name\n          sessionGroupId\n        }\n      }\n    }\n  }\n":
    types.SessionGroupArtifactPageDocument,
  "\n  mutation AddChannelMember($input: AddChannelMemberInput!) {\n    addChannelMember(input: $input) {\n      id\n    }\n  }\n":
  ...
  "\n  mutation StartSessionApplicationWorkflow($sessionGroupId: ID!, $appConfigId: ID!) {\n    startSessionApplicationWorkflow(sessionGroupId: $sessionGroupId, appConfigId: $appConfigId) {\n      id\n    }\n  }\n":
    types.StartSessionApplicationWorkflowDocument,
  "\n  query SessionEndpointTrafficEndpoints($sessionGroupId: ID!) {\n    sessionEndpoints(sessionGroupId: $sessionGroupId) {\n      id\n      key\n      url\n      sessionGroupId\n      appConfigId\n      processConfigId\n      portConfigId\n      label\n      targetPort\n      status\n      accessMode\n      trafficCaptureMode\n      enabledAt\n      disabledAt\n      revokedAt\n    }\n  }\n":
