...
export type AvailableRuntimesQuery = { __typename?: 'Query', availableRuntimes: Array<{ __typename?: 'SessionRuntimeInstance', id: string, label: string, hostingMode: HostingMode, supportedTools: Array<CodingTool>, connected: boolean, sessionCount: number }> };
