...
export type QuerySessionGroupsArgs = {
  channelId: Scalars['ID']['input'];
  excludeStatuses?: InputMaybe<Array<SessionGroupStatus>>;
};
...
export type SessionGroupsQueryVariables = Exact<{
  channelId: Scalars['ID']['input'];
  excludeStatuses?: InputMaybe<Array<SessionGroupStatus> | SessionGroupStatus>;
}>;
