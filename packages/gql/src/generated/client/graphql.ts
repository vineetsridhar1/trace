...
export type SessionGroupsQuery = { __typename?: 'Query', sessionGroups: Array<{ __typename?: 'SessionGroup', id: string, name: string, slug?: string | null, status: SessionGroupStatus, prUrl?: string | null, worktreeDeleted: boolean, archivedAt?: string | null, setupStatus: SetupStatus, setupError?: string | null, createdAt: string, updatedAt: string, channel?: { __typename?: 'Channel', id: string } | null, sessions: Array<{ __typename?: 'Session', id: string, name: string, agentStatus: AgentStatus, sessionStatus: SessionStatus, tool: CodingTool, model?: string | null, hosting: HostingMode, branch?: string | null, prUrl?: string | null, worktreeDeleted: boolean, sessionGroupId?: string | null, createdAt: string, updatedAt: string, connection?: { __typename?: 'SessionConnection', state: SessionConnectionState, runtimeInstanceId?: string | null, runtimeLabel?: string | null, lastError?: string | null, retryCount: number, canRetry: boolean, canMove: boolean } | null, createdBy: { __typename?: 'User', id: string, name: string, avatarUrl?: string | null }, repo?: { __typename?: 'Repo', id: string, name: string } | null, channel?: { __typename?: 'Channel', id: string } | null }> }> };
...
export type FilteredSessionGroupsQuery = { __typename?: 'Query', sessionGroups: Array<{ __typename?: 'SessionGroup', id: string, name: string, status: SessionGroupStatus, prUrl?: string | null, worktreeDeleted: boolean, archivedAt?: string | null, setupStatus: SetupStatus, setupError?: string | null, createdAt: string, updatedAt: string, channel?: { __typename?: 'Channel', id: string } | null, sessions: Array<{ __typename?: 'Session', id: string, name: string, agentStatus: AgentStatus, sessionStatus: SessionStatus, tool: CodingTool, model?: string | null, hosting: HostingMode, branch?: string | null, prUrl?: string | null, worktreeDeleted: boolean, sessionGroupId?: string | null, createdAt: string, updatedAt: string, connection?: { __typename?: 'SessionConnection', state: SessionConnectionState, runtimeInstanceId?: string | null, runtimeLabel?: string | null, lastError?: string | null, retryCount: number, canRetry: boolean, canMove: boolean } | null, createdBy: { __typename?: 'User', id: string, name: string, avatarUrl?: string | null }, repo?: { __typename?: 'Repo', id: string, name: string } | null, channel?: { __typename?: 'Channel', id: string } | null }> }> };
...
export type SendSessionMessageMutationVariables = Exact<{
  sessionId: Scalars['ID']['input'];
  text: Scalars['String']['input'];
  imageKeys?: InputMaybe<Array<Scalars['String']['input']> | Scalars['String']['input']>;
  interactionMode?: InputMaybe<Scalars['String']['input']>;
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
}>;
...
export const SendSessionMessageDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"SendSessionMessage"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"sessionId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"text"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"imageKeys"}},"type":{"kind":"ListType","type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"interactionMode"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"clientMutationId"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"sendSessionMessage"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"sessionId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"sessionId"}}},{"kind":"Argument","name":{"kind":"Name","value":"text"},"value":{"kind":"Variable","name":{"kind":"Name","value":"text"}}},{"kind":"Argument","name":{"kind":"Name","value":"imageKeys"},"value":{"kind":"Variable","name":{"kind":"Name","value":"imageKeys"}}},{"kind":"Argument","name":{"kind":"Name","value":"interactionMode"},"value":{"kind":"Variable","name":{"kind":"Name","value":"interactionMode"}}},{"kind":"Argument","name":{"kind":"Name","value":"clientMutationId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"clientMutationId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}}]}}]} as unknown as DocumentNode<SendSessionMessageMutation, SendSessionMessageMutationVariables>;
