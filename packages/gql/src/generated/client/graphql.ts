...
export type OrgMembersQuery = { __typename?: 'Query', organization?: { __typename?: 'Organization', id: string, members: Array<{ __typename?: 'User', id: string, name: string, email: string, avatarUrl?: string | null, role: UserRole }> } | null };
