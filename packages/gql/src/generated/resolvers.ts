...
> = ResolversObject<{
  ...
  >;
  setSessionBranch?: Resolver<
    ResolversTypes["Session"],
    ParentType,
    ContextType,
    RequireFields<MutationSetSessionBranchArgs, "branch" | "sessionId">
  >;
  setSessionTitle?: Resolver<
    ResolversTypes["Session"],
    ParentType,
    ContextType,
    RequireFields<MutationSetSessionTitleArgs, "sessionId" | "title">
  >;
