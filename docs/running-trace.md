...
TRACE_REALTIME_BACKPLANE_ENABLED=1
...
services:
  ...
  backend:
    ...
    environment:
      ...
      TRACE_AUTH_COOKIE_SAME_SITE: "lax"
      TRACE_CLOUD_SESSION_GROUP_IDLE_CLEANUP_AFTER_MS: ${TRACE_CLOUD_SESSION_GROUP_IDLE_CLEANUP_AFTER_MS:-3600000}
