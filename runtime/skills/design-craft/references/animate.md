...
- **Device-framed designs:** specify motion intent and reduced-motion behavior for the React implementation without implying native runtime APIs.
...
When motion earns its place, use [polish.md](polish.md) for the final path-wide pass.
