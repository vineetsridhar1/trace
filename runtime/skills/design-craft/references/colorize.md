...
Read the available design-system guidance, tokens, assets, current themes, and representative states. Identify:
...
When the palette earns its place, use [polish.md](polish.md) for the final path-wide pass.
