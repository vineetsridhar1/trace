...
Use this action to amplify a surface whose visual world is already established. If the user is choosing an entirely new direction, use [new-work.md](new-work.md) instead.
...
When the target holds its own without pulling the page apart, use [polish.md](polish.md) for the final path-wide pass.
