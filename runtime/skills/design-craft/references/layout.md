...
- **Platform-specific work:** follow the active workspace's navigation, inset, adaptation, and touch-target guidance.
...
Run these as separate passes. Complete the structural assessment before reading mechanical results.
...
2. **Mechanical scan:** use the workspace's native checks for overflow, stacking, clipping, invalid containers, and arbitrary spacing. Keep mechanical evidence out of the first assessment, then synthesize both passes before editing. A clean scan cannot prove hierarchy or rhythm.
...
When the structure holds, use [polish.md](polish.md) for the final path-wide pass.
