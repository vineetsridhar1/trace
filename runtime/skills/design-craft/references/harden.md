...
- [Assess hardening needs](#assess-hardening-needs)
- [Text, localization, errors, and boundaries](#hardening-dimensions)
...
When edge cases are covered, use [polish.md](polish.md) for the final path-wide pass.
