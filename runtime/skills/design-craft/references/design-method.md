...
- `read`: understand material. Reading rhythm, hierarchy, source trust, and wayfinding come first.
- `experience`: engage with the work itself. The artifact leads and interface chrome recedes.
...
- Refinement preserves identity, behavior, factual content, and everything outside scope.
- Redesign preserves product truth and constraints but replaces the rejected visual world fully.
- User-supplied brand rules and references beat general taste guidance.
...
- information topology and first-viewport hierarchy;
- palette roles and color strategy;
- type character and role scale;
- spacing, density, shape, and elevation grammar;
- component and state behavior;
- signature product-specific module or interaction;
- responsive rules and honest risk.

## Craft floor

- Design the real workflow with honest content and meaningful states.
- Use tight spacing inside groups and generous separation between groups.
- Keep body measure readable, type roles obvious, and every string safe at its viewport.
- Use color for hierarchy, meaning, and atmosphere; secondary text on colored surfaces should derive from that surface, not default gray.
- Avoid interchangeable scaffolds: repeated icon-heading-text cards, nested cards, decorative metric tiles, gradient text, arbitrary glass, glow halos, and mono type used as a costume.
- Theme focus, selection, caret, scrollbar, underlines, and tabular numerals when they are visible parts of the experience.
