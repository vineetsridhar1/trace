...
2. Visually inspect the recording for content that metadata cannot identify, then run gate 10. If
   validation fails or anything is sensitive, misleading, corrupt, or oversized, do not upload it.
