...
/** Retry a fresh terminal attach while the bridge makes the terminal available. */
  ...
  private openSocket(): void {
    ...
    this.ws.onmessage = (event) => {
      try {
        ...
        // "Terminal not found" can be transient while a new terminal becomes available
        // or while the bridge restores its terminal state.
