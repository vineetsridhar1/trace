...
const TABS: readonly Tab[] = [
  ...
  { id: "channels", label: "Channels", icon: Code, group: "Workspace" },
  { id: "connections", label: "Connections", icon: Plug, group: "Workspace" },
  ...
  { id: "appearance", label: "Appearance", icon: Palette, group: "Your account" },
  { id: "notifications", label: "Notifications", icon: Bell, group: "Your account" },
...
const TAB_DETAILS: Record<SettingsTab, { title: string; description: string; wide?: boolean }> = {
  ...
  channels: {
    title: "Channels",
    description: "Organize the workspace channels available to your team.",
    wide: true,
  },
  connections: {
    title: "Connections",
    description: "Manage connected services and accounts.",
    wide: true,
  },
  "agent-environments": {
  ...
  appearance: {
    title: "Appearance",
    description: "Choose how Trace looks on this device.",
  },
  notifications: {
    title: "Notifications",
    description: "Control which activity alerts you receive.",
  },
  "api-keys": {
    title: "API keys",
  ...
  "coding-tools": {
    title: "Coding tools",
    description: "Install and update the coding agents available on this device.",
    wide: true,
  },
};
