    ...
    <div className="space-y-1 pb-3 pt-2">
      <div className="group/generated-projects-header flex items-center justify-between rounded-md pr-1 transition-colors hover:bg-white/10">
        <button
          ...
          className="flex flex-1 cursor-pointer items-center gap-1 rounded-md px-0 py-1 pl-2 text-left text-xs font-semibold uppercase tracking-wider text-cyan-300/65 transition-colors focus-visible:ring-2 focus-visible:ring-ring"
        >
          <ChevronRight
            size={14}
