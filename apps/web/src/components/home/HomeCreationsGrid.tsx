...
const CREATION_TYPES: Array<{ id: "all" | "app"; label: string }> = [
  { id: "all", label: "All" },
  { id: "app", label: "Apps" },
];
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
        <div>
          ...
          <p className="mt-0.5 text-xs text-[var(--th-muted)]">
            Browse and continue previous work.
          </p>
        </div>
      ...
      <div className="group relative min-h-24 overflow-hidden rounded-[10px] border border-[var(--th-edge)] bg-[var(--th-surface)] transition-colors hover:border-[var(--th-edge-hover)] hover:bg-white/[0.025]">
        ...
        >
          <div className="flex min-h-24 flex-col p-4 pr-10">
            ...
            <span className="mt-3 truncate text-sm font-medium text-[var(--th-heading)]">
              {title}
            </span>
...
function isCreation(group: SessionGroupEntity): boolean {
  return group.kind === "app";
}
