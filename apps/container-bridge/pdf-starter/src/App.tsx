export function App() {
  return (
    <div
      data-trace-id="document-root"
      data-trace-source="src/App.tsx"
      className="px-[18mm] py-[20mm]"
    >
      <header
        data-trace-id="document-header"
        data-trace-source="src/App.tsx"
        className="border-b border-stone-200 pb-10"
      >
        <p
          data-trace-id="document-kicker"
          data-trace-source="src/App.tsx"
        ...
        <h1
          data-trace-id="document-title"
          data-trace-source="src/App.tsx"
          className="mt-4 max-w-xl text-5xl font-semibold tracking-tight text-stone-950"
        >
          Your document starts here.
        </h1>
        <p
          data-trace-id="document-introduction"
          data-trace-source="src/App.tsx"
      ...
      <section
        data-trace-id="document-overview"
        data-trace-source="src/App.tsx"
        className="mt-12 break-inside-avoid"
      >
        <h2
          data-trace-id="document-overview-title"
          data-trace-source="src/App.tsx"
        ...
        <p
          data-trace-id="document-overview-copy"
          data-trace-source="src/App.tsx"
      ...
      <section
        data-trace-id="document-cards"
        data-trace-source="src/App.tsx"
        className="mt-10 grid gap-5 sm:grid-cols-2"
      >
        <div
          data-trace-id="document-paper-card"
          data-trace-source="src/App.tsx"
          className="break-inside-avoid rounded-lg border border-stone-200 p-5"
        >
          <p
            data-trace-id="document-paper-title"
            data-trace-source="src/App.tsx"
          ...
          <p
            data-trace-id="document-paper-copy"
            data-trace-source="src/App.tsx"
        ...
        <div
          data-trace-id="document-change-card"
          data-trace-source="src/App.tsx"
          className="break-inside-avoid rounded-lg border border-stone-200 p-5"
        >
          <p
            data-trace-id="document-change-title"
            data-trace-source="src/App.tsx"
            className="text-sm font-semibold text-stone-950"
          >
            Built to change
          ...
          <p
            data-trace-id="document-change-copy"
            data-trace-source="src/App.tsx"
            className="mt-2 text-sm leading-6 text-stone-600"
          >
