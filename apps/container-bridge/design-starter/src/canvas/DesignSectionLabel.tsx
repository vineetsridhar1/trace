...
export const SECTION_LABEL_GAP = 72;
...
export function DesignSectionLabel({
  ...
  return (
    ...
    <h2
      className="absolute bottom-0 left-0 origin-bottom-left whitespace-nowrap text-[20px] font-semibold leading-7 uppercase tracking-[0.18em] text-zinc-600"
