...
This copy is embedded in a Trace Design workspace. The Trace artifact contract in `CLAUDE.md` and `docs/ai-guidance.md` has precedence over this skill and every linked reference. Apply the full design judgment, command playbooks, craft floor, critique methods, and detector, with these translations:
