...
- `responsive-web.md` — responsive product experiences across representative breakpoints.
- `marketing-site.md` — conversion, editorial, launch, and product-marketing surfaces.
...
These playbooks refine the shared artifact contract in `../ai-guidance.md`; they never override it.
