  ...
  return (
    <View>
      <View style={styles.readyRow}>
        ...
        <Text variant="footnote" style={styles.ready}>Ready to send</Text>
      </View>
      <Text variant="title1" style={styles.title}>Ready to send your answers?</Text>
        ...
        {questions.map((question, index) => {
          ...
          return (
            <View key={question.id ?? String(index)} style={styles.row}>
              <Text variant="caption1" style={styles.check}>✓</Text>
              ...
              <Pressable
                ...
                style={styles.edit}
              >
                <Text variant="caption1" style={styles.muted}>Edit</Text>
              </Pressable>
            </View>
          );
        })}
...
const styles = StyleSheet.create({
  ...
  list: { marginTop: 24, borderWidth: 1, borderColor: questionColors.border, borderRadius: questionMetrics.controlRadius, overflow: "hidden", backgroundColor: "rgba(23,23,25,0.88)" },
  row: { minHeight: 70, paddingHorizontal: 16, paddingVertical: 12, flexDirection: "row", alignItems: "center", gap: 12, borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: questionColors.border },
  check: { width: 24, height: 24, borderRadius: 12, lineHeight: 24, textAlign: "center", color: questionColors.success, backgroundColor: "rgba(48,209,88,0.15)", fontWeight: "700" },
  copy: { flex: 1, gap: 4 },
