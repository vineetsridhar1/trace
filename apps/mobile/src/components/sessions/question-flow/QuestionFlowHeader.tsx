    ...
    <View style={styles.row}>
      <Glass preset="input" interactive style={styles.circle}>
        ...
        >
          <SymbolView
            name="chevron.left"
            size={22}
            tintColor={questionColors.foreground}
            weight="medium"
          />
        </Pressable>
      </Glass>
      <Glass preset="card" interactive style={styles.titlePill}>
        ...
        <View style={styles.copy}>
          ...
          <Text variant="caption2" style={styles.subtitle} numberOfLines={1}>
            {step}
          </Text>
        </View>
      </Glass>
...
const styles = StyleSheet.create({
  ...
  copy: { flex: 1 },
  title: { color: questionColors.foreground, fontSize: 18, lineHeight: 20, fontWeight: "600" },
