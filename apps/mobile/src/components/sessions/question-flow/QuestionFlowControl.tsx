...
const styles = StyleSheet.create({
  ...
  otherInput: { minHeight: 96, borderWidth: 1, borderColor: "rgba(0,116,225,0.5)", borderRadius: questionMetrics.controlRadius, padding: 12, fontSize: 14, color: questionColors.foreground, backgroundColor: "rgba(23,23,25,0.88)", textAlignVertical: "top" },
});
