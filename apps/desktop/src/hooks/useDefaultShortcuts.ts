...
export function useDefaultShortcuts({
  ...
  useHotkey(
    "tab.agent",
    "mod+1",
    () => usePanelLayoutStore.getState().activateTab("agent"),
    {
      label: "Agent tab",
      category: "navigation",
      context: "thread-open",
  ...
  useHotkey(
    "tab.ticket",
    "mod+2",
    () => usePanelLayoutStore.getState().activateTab("ticket"),
    {
      label: "Ticket tab",
      category: "navigation",
      context: "thread-open",
  ...
  useHotkey(
    "tab.files",
    "mod+3",
    () => usePanelLayoutStore.getState().activateTab("files"),
    {
      label: "Files tab",
      category: "navigation",
      context: "thread-open",
  ...
  useHotkey(
    "tab.terminal",
    "mod+4",
    () => usePanelLayoutStore.getState().activateTab("terminal"),
    {
      label: "Terminal tab",
      category: "navigation",
      context: "thread-open",
  ...
  useHotkey(
    "tab.browser",
    "mod+5",
    () => usePanelLayoutStore.getState().activateTab("browser"),
    {
      label: "Browser tab",
      category: "navigation",
      context: "thread-open",
  ...
  useHotkey(
    ...
    "mod+backspace",
    () => {
      void useAgentRunStore.getState().workspaceActions.stopAgent();
    },
