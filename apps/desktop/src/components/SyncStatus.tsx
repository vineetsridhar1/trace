      ...
      {isChecking ? (
        ...
        <>
          ...
          <button
            type="button"
            onClick={() =>
              void useSyncStore.getState().checkMainBranch(repoPath, baseBranch)
            }
        ...
        <>
          ...
          >
            {baseBranch} is {commitsBehind} commit
            {commitsBehind !== 1 ? "s" : ""} behind
          </span>
          <button
            type="button"
            onClick={() =>
              void useSyncStore.getState().pullMainBranch(repoPath, baseBranch)
            }
            disabled={isPulling}
