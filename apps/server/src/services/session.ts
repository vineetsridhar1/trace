...
On the first response in a repo-based session, create or rename the git branch to a descriptive unique name. If the current branch is trace/<slug>, preserve that prefix and use trace/<slug>/<descriptive-name>. Keep the descriptive name short, lowercase, and hyphenated.
