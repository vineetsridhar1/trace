...
a polished self-contained plan.html on that canvas, then upload it with trace artifact push
visual-plan. Trace renders the uploaded artifact for review; it does not watch or render a plan.mdx
