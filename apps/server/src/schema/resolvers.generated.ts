...
import    { myWorkspacesMergedCount as Query_myWorkspacesMergedCount } from './workspace/resolvers/Query/myWorkspacesMergedCount';
...
import    { JSON } from './base/resolvers/JSON';
    export const resolvers: Resolvers = {
      Query: { aiChatMessages: Query_aiChatMessages,aiChats: Query_aiChats,board: Query_board,channel: Query_channel,channelMessages: Query_channelMessages,channelPresence: Query_channelPresence,channels: Query_channels,checkPRStatuses: Query_checkPRStatuses,event: Query_event,generateBranchName: Query_generateBranchName,instance: Query_instance,me: Query_me,myInstances: Query_myInstances,myWorkspaces: Query_myWorkspaces,myWorkspacesMergedCount: Query_myWorkspacesMergedCount,servers: Query_servers,sessionEvents: Query_sessionEvents,sessions: Query_sessions,suggestScripts: Query_suggestScripts,ticketByWorkspaceId: Query_ticketByWorkspaceId,ticketDependencies: Query_ticketDependencies,workspace: Query_workspace,workspaceEvents: Query_workspaceEvents,workspaces: Query_workspaces },
