...
import { useCreateChannelMutation } from "./__generated__/CreateChannelModal.generated";
...
export function CreateChannelModal({
  ...
  const [detectedOriginUrl, setDetectedOriginUrl] = useState<string | null>(
    null,
  );
  ...
  const handleSelectFolder = useCallback(async () => {
    ...
    try {
      ...
      const fetchedBranches: string[] = branchResult.success
              ...
              {teams.length > 0 ? (
                <>
                  ...
                  >
                    <span
                      className={
                        selectedTeamIds.length === 0 ? "text-[#404040]" : ""
                      }
                    >
                  ...
                  <div>
                    ...
                    {repoValid === true && detectedOriginUrl && (
                      <p className="mt-1 text-xs text-green-400">
                        Origin:{" "}
                        <span className="text-muted">{detectedOriginUrl}</span>
                      </p>
                    )}
                  ...
                  {repoValid && branches.length > 0 && (
                    <div className="relative">
                      ...
                      <p className="mt-1 text-xs text-muted">
                        Branch to merge worktrees into
                      </p>
                    </div>
                  )}
                    ...
                    <>
                      ...
                      <div>
                        ...
                        <div className="rounded border border-edge bg-surface-deep px-3 py-2 space-y-0.5 text-xs text-muted">
                          ...
                          <p>
                            <code className="text-green-400">$REPO_FOLDER</code>{" "}
                      ...
                      <div className="border-t border-edge pt-4">
                        ...
                        <div className="mb-4">
                          ...
                          <textarea
                            ...
                            onChange={(e) =>
                              setDefaultSetupScript(e.target.value)
                            }
                        ...
                        <div>
                          ...
                          <textarea
                            ...
                            onChange={(e) =>
                              setDefaultRunScript(e.target.value)
                            }
                      ...
                      <div className="border-t border-edge pt-4">
                        ...
                        <div className="mb-4">
                          <div className="mb-2">
                            ...
                            <p className="text-xs text-muted">
                              Runs when a new workspace is created and will
                              override the default setup script
                            </p>
                          </div>
                          <textarea
                            value={mySetupScript}
                        ...
                        <div className="mb-4">
                          <div className="mb-2">
                            ...
                            <p className="text-xs text-muted">
                              Runs when you click the play button and will
                              override the default run script
                            </p>
                          </div>
                          <textarea
                            value={myRunScript}
                        ...
                        <div>
                          ...
                          <textarea
                            ...
                            onChange={(e) =>
                              setMySystemInstructions(e.target.value)
                            }
                            placeholder={
