...
export type MeQuery = { __typename?: 'Query', me?: { __typename?: 'AuthUser', id: string, email: string, name: string, avatarUrl?: string | null, role: string, githubUsername?: string | null } | null };
