...
- Orchestration phase: sequential ticket execution driven by explicit Claude orchestrator episodes and playbooks.
...
- Orchestration is episodic: lifecycle event in, normal Claude session out.
...
| 02 | [Plan Approval And Ticket Generation](02-plan-approval-ticket-generation.md) | Next action, plan persistence, AI/CLI ticket generation, linked tickets |
...
| 06 | [Orchestrator Episode Runtime](06-orchestrator-episode-runtime.md) | New Claude session per lifecycle event |
