...
export const createChannel: NonNullable<MutationResolvers['createChannel']> = async (_parent, { name, serverId, githubUrl, baseBranch, defaultRepoPath, defaultSetupScript, defaultRunScript }, _ctx) => {
  ...
  return createChannelService({
    ...
    defaultRepoPath: defaultRepoPath || null,
